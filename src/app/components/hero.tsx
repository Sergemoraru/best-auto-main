    ...
    <div className="bg-white">
      <main>
        <div className="relative isolate">
          ...
          >
            <div
              className="aspect-[801/1036] w-[50.0625rem] bg-gradient-to-tr from-[#475569] to-[#0e7490] opacity-30"
              style={{
                clipPath:
              ...
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                    Rev Up Your Savings: Unleash the Best Auto Deals of the
                    Season!
                  </h1>
                  <p className="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                    Discover unbeatable prices and a range of vehicles. From
                    sedans to SUVs and eco-friendly hybrids, find a car without
                    breaking the bank. Explore limited-time promotions and
                    financing options to elevate your driving experience while
                  ...
                  <div className="w-44 flex-none space-y-8 pt-32 sm:pt-0">
                    <div className="relative">
                      <Image
                        width={396}
                        height={528}
                        src="/images/heroimages/hands-female-mechanic-using-laptop.jpg"
                        alt=""
                        className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                      />
                      <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
